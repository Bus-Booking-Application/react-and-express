...
export default function Sidebar() {
  return (
    <div className="w-64 bg-primary text-primary-foreground min-h-screen p-4">
      <h2 className="text-2xl font-bold mb-6">Travel Panel</h2>
      <nav className="space-y-4">
        <Link to="/" className="block">Agent Dashboard</Link>
        {/* <Link to="/register-Customer" className="block">Customer Register</Link> */}
